...
def main(argv):
    ...
    kukaenv = kukaPushGymEnvHer(urdfRoot=robot_data.getDataPath(), renders=rend, useIK=0, isDiscrete=discreteAction, numControlledJoints = numControlledJoints, fixedPositionObj = fixed, includeVelObs = True)
    ...
    model = HER(CustomPolicy, kukaenv, model_class, n_sampled_goal=4, goal_selection_strategy=goal_selection_strategy,
                verbose=1,tensorboard_log="../pybullet_logs/kuka_reach_ddpg/pushing_DDPG_HER_PHASE_1", buffer_size=1000000,batch_size=256,
